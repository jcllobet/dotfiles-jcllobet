...
# Three finger drag
# https://apple.stackexchange.com/q/110277
# You need to log out in order for this to take effect
...
# - enable Three finger drag on older macOS
#defaults -currentHost write NSGlobalDomain com.apple.trackpad.threeFingerSwipeGesture -int 1
#defaults write com.apple.AppleMultitouchTrackpad TrackpadThreeFingerDrag -bool true
#defaults write com.apple.driver.AppleBluetoothMultitouch.trackpad TrackpadThreeFingerDrag -bool true
# - enable Three finger drag on Monterey
#defaults write com.apple.AppleMultitouchTrackpad DragLock -bool false
#defaults write com.apple.AppleMultitouchTrackpad Dragging -bool false
#defaults write com.apple.AppleMultitouchTrackpad TrackpadThreeFingerDrag -bool true
# - enable Four finger down App Expose
...
#defaults write NSGlobalDomain KeyRepeat -int 2 # Mathias Bynens: 1
#defaults write NSGlobalDomain InitialKeyRepeat -int 15 # Mathias Bynens: 10
...
# The command below stops the keyboard media from working at all
# (was originally: "Stop iTunes from responding to the keyboard media keys")
...
# Set the user as the default location for new Finder windows
...
# Set the icon size of Dock items to 47 pixels
defaults write com.apple.dock tilesize -int 47 # Mathias Bynens: 36
